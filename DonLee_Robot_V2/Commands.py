...
async def about(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          Import.Button("👨‍💻𝖣𝖾𝗉𝗅𝗈𝗒", url='https://t.me/CvNewRelease'),
...
async def sub(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[     
          Import.Button("🖥️𝖵𝗂𝖽𝖾𝗈", url="https://t.me/CvNewRelease"),
          Import.Button("𝖲𝗎𝗉𝗉𝗈𝗋𝗍🤝", url="https://t.me/CvNewRelease")
          ],[
          Import.Button("📢𝖴𝗉𝖽𝖺𝗍𝖾𝗌", url="https://t.me/CvNewRelease"),
          Import.Button("𝖸𝗈𝗎𝖳𝗎𝖻𝖾💞", url="https://t.me/CvNewRelease")
          ],[
          Import.Button("📦𝖦𝗂𝗍𝗁𝗎𝖻", url="https://github.com/navaneethrkrishna007"),
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="t.TheMaster_TG")
       ]]
    await msg.reply_text(
